...
from census.views import census_display, census_create_by_city,census_delete_by_city,census_create_by_localidad, census_delete_by_localidad ,census_create_by_age,census_delete_by_age, census_create_by_genero, census_delete_by_genero
